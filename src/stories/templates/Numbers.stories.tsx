...
export const ByTheNumbers: Story = {
  args: {
    ...
    stats: [
      { value: '35%+', label: 'new active customers' },
      { value: '40%+', label: 'increase in reservations made' },
      { value: '35%+', label: 'increase in room nights booked' },
      { value: '33%+', label: 'in hotel bookings revenue' },
    ],
    cards: [
      {
        value: '480K',
        label: 'Reservation Made',
        prior: { value: '352K', period: '’23', amount: 464 },
        current: { value: '480K', period: '’24', amount: 650 },
      },
      {
        value: '1.7m',
        label: 'Room Nights Booked',
        prior: { value: '1.3M', period: '’23', amount: 1.3 },
        current: { value: '1.7M', period: '’24', amount: 1.7 },
      },
      {
        value: '$214M',
        label: 'Hotel Bookings',
        prior: { value: '$196M', period: '’23', amount: 283 },
        current: { value: '$248M', period: '’24', amount: 377 },
      },
    ],
  },
}
