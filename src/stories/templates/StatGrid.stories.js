 ...
 * object handed to the template, which is the contract the whole system is
 * built on: a new slide is data, not markup.
 */
import StatGrid from '../../templates/StatGrid.vue'
...
is passed straight through to \`StatCard\`, so a single row can mix the
\`muted\` (#f5f5f5) and \`brand\` (gradient) fills the way the
revenue-durability slide does.
...
export const RevenueDurability = {
  args: {
    ...
    height: 390,
    cards: [
      { value: '615K', label: 'Gross Revenue Retention', description: 'Booking volume retained from the prior-year cohort, before expansion.', order: 'value-first', valueSize: 'statSm', align: 'top' },
      { value: '615K', label: 'Net Revenue Retention', description: 'Including expansion inside existing accounts — the platform growing per customer.', order: 'value-first', valueSize: 'statSm', align: 'top' },
      { value: '615K', label: 'Logo Retention', description: 'Share of active customers retained year over year.', order: 'value-first', valueSize: 'statSm', align: 'top' },
      { value: '615K', label: 'Top-10 Concentration', description: 'Share of 2025 revenue from the ten largest customers.', order: 'value-first', valueSize: 'statSm', align: 'top', surface: 'brand' },
      { value: '615K', label: 'Largest Single Customer', description: 'The single-customer exposure an investor underwrites first.', order: 'value-first', valueSize: 'statSm', align: 'top', surface: 'brand' },
      { value: '615K', label: '2024 Cohort Expansion', description: 'What the 2024 cohort spent in 2025 versus 2024 — the compounding proof.', order: 'value-first', valueSize: 'statSm', align: 'top', surface: 'brand' },
    ],
  },
}
